...
export default function PrivacyPolicyText() {
  return (
    <>
      <Text>
        The people who will use your chatbot have rights over their data. They
        have:
      </Text>
      <List.Root marginLeft={4}>
        <List.Item>a right to privacy;</List.Item>
        <List.Item>a right to edit and access their own information;</List.Item>
        <List.Item>
      ...
      <List.Root as="ol" marginBottom={8}>
        <List.Item>
          ...
          <Text marginTop={4}>
            If you do not have a privacy policy, now is the time to think about
            data for the chatbot you are building.
          </Text>
          <List.Root as="ol" marginLeft={4} marginTop={4}>
            ...
            <List.Item>
              How is it processed?{" "}
              <Text as="span" fontStyle="italic">
                (What will you do with the data you collect? How will you be
          ...
          <Text marginTop={4}>Some top tips:</Text>
          <List.Root marginLeft={4} marginTop={2}>
            <List.Item>Use simple language</List.Item>
            <List.Item>
              Update it regularly and inform the people using your service of
              any changes
            </List.Item>
            <List.Item>
              If you have a full privacy policy, we recommend linking to it at
        ...
        <List.Item>
          ...
          <List.Root marginLeft={4} marginTop={2}>
            <List.Item>
              This bot or automated messaging system is built using a tool
              called Bitpart.
            </List.Item>
            <List.Item>
